        ...
        <div className="container">
          ...
          <div className="mt-16">
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 md:grid-cols-4 stagger-children">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="flex items-center justify-center rounded-lg border bg-card p-6 hover-scale hover-glow animate-fade-in-up">
                  <div className="h-12 w-32 bg-muted/30"></div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6 md:grid-cols-6 stagger-children">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div key={i} className="flex items-center justify-center rounded-lg border bg-card p-4 hover-scale hover-glow animate-fade-in-up">
                  <div className="h-8 w-24 bg-muted/30"></div>
                </div>
              ))}
            </div>
          </div>
